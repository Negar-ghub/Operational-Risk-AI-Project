...
​risk-detector.py: Tüm kod yapısı bu tek dosyada yer almaktadır. Dosya, sentetik veri seti oluşturma (simulating operational risks), Isolation Forest modelinin eğitimi ve anomali skorlarının hesaplanması adımlarını içermektedir.
